...
export default function Mapping() {
  ...
  // Global mouse handlers for dragging deadzone overlay
  useEffect(() => {
  ...
  }, [isDraggingOverlay, dragStart, activeStick]);
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="relative w-[1188px] h-[771px]">
            ...
            <div
              className="absolute"
              style={{
                left: `${activeStick === 'left' ? leftStickPosition.left : rightStickPosition.left}px`,
                top: `${activeStick === 'left' ? leftStickPosition.top : rightStickPosition.top}px`,
                width: '117px',
                height: '117px',
