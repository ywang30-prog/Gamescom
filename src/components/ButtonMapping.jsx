...
export default function ButtonMapping() {
  ...
  const [hotspotPositions, setHotspotPositions] = useState(() => {
    const defaultsFront = {
      'Left Stick': { left: 459, top: 321 },
      'Left Bumper': { left: 361, top: 75 },
      'D Pad Up': { left: 351, top: 134 },
      'D Pad Left': { left: 351, top: 279 },
      'D Pad Down': { left: 278, top: 207 },
      'D Pad Right': { left: 423, top: 207 },
      'Right Bumper': { left: 812, top: 75 },
      'Button Y': { left: 818, top: 130 },
      'Button B': { left: 892, top: 207 },
      'Button X': { left: 740, top: 207 },
      'Button A': { left: 818, top: 290 },
      'Right Stick': { left: 706, top: 321 },
      'Left Trigger': { left: 473, top: 72 },
      'Right Trigger': { left: 697, top: 72 },
      'Menu Button': { left: 711, top: 109 },
      'View Button': { left: 451, top: 109 },
      'Button Share': { left: 502, top: 222 },
  ...
  const [tooltipPositions, setTooltipPositions] = useState(() => {
    const defaultsFront = {
      leftStick: { left: 97, top: 661 },
      leftBumper: { left: 97, top: 36 },
      dPadUp: { left: 97, top: 212 },
      dPadLeft: { left: 97, top: 304 },
      dPadDown: { left: 97, top: 392 },
      dPadRight: { left: 97, top: 481 },
      rightBumper: { left: 1074, top: 36 },
      buttonY: { left: 1076, top: 211 },
      buttonB: { left: 1077, top: 304 },
      buttonX: { left: 1077, top: 481 },
      buttonA: { left: 1077, top: 392 },
      rightStick: { left: 1077, top: 661 },
      buttonShare: { left: 97, top: 569 },
      viewButton: { left: -12, top: 124 },
      menuButton: { left: 1183, top: 124 },
      profileButton: { left: 1186, top: 569 },
    };
    const defaultsBack = {
      leftStick: { left: 97, top: 468 },
      leftTrigger: { left: -9, top: 167 },
      dPadUp: { left: 97, top: 212 },
      dPadDown: { left: 97, top: 49 },
      rightTrigger: { left: 1189, top: 167 },
      buttonY: { left: 1076, top: 211 },
      buttonA: { left: 1082, top: 49 },
      rightStick: { left: 1082, top: 468 },
    };
    const defaults = {
      front: defaultsFront,
      back: defaultsBack,
  ...
  const handleProfileSelect = (profileId) => {
    ...
    const savedMappings = localStorage.getItem(`buttonMappings_${profileId}`);
    const savedTooltips = localStorage.getItem(`tooltipAssignments_${profileId}_${presetConfig}`);
    ...
    if (savedTooltips) {
      ...
      // Clear old format key if it exists
      localStorage.removeItem(`tooltipAssignments_${profileId}`);
      // Reset to defaults if no saved data
      setTooltipAssignments({...defaults});
    }
    ...
    setTimeout(() => {
      setSavedSettings({
        assignments: savedMappings ? JSON.parse(savedMappings) : (
          buttonMappings.reduce((acc, btn) => ({ ...acc, [btn.id]: btn.defaultAssignment }), {})
        ),
        tooltips: savedTooltips ? JSON.parse(savedTooltips) : {...defaults},
      });
  ...
  return (
    <div className="bg-black relative overflow-hidden h-screen w-full">
      <style>{`
        .custom-scrollbar {
          overflow: overlay;
        }
